...
algorithm_choice = st.sidebar.radio(
    ...
    help="Rotational: Cycles people through positions in order. 
    Simple: I honestly don't remember what I built this one to do. It will technically give you a schedule though, so I'm leaving it lol. 
    Heuristic: Fills in all Conductor positions for the day and then fills in the rest by half-hour. 
Backtracking: Tries all combinations to find the optimal one."
)
